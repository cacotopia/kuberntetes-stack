...
{{- $registryName := default .Values.agent.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.agent.image.repository -}}
{{- $tag := default .Values.agent.image.tag .Values.global.image.tag | toString -}}
{{- if $registryName }}
...
*/}}
{{/*
Return the proper jaeger-ingester image name
*/}}
{{- define "jaeger.ingester.image" -}}
{{- $registryName := default .Values.ingester.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.ingester.image.repository -}}
{{- $tag := default .Values.ingester.image.tag .Values.global.image.tag | toString -}}
{{- if $registryName }}
    {{- printf "%s/%s:%s" $registryName $repositoryName $tag -}}
{{- else -}}
    {{- printf "%s:%s"  $repositoryName $tag -}}
...
{{- $registryName := default .Values.collector.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.collector.image.repository -}}
{{- $tag := default .Values.collector.image.tag .Values.global.image.tag | toString -}}
  {{- if $registryName }}
      {{- printf "%s/%s:%s" $registryName $repositoryName $tag -}}
  {{- else -}}
      {{- printf "%s:%s"  $repositoryName $tag -}}
...
{{- $registryName := default .Values.query.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.query.image.repository -}}
{{- $tag := default .Values.query.image.tag .Values.global.image.tag | toString -}}
{{- if $registryName }}
    {{- printf "%s/%s:%s" $registryName $repositoryName $tag -}}
{{- else -}}
    {{- printf "%s:%s"  $repositoryName $tag -}}
...
*/}}
{{/*
Return the proper hotrod image name
*/}}
{{- define "jaeger.hotrod.image" -}}
{{- $registryName := default .Values.hotrod.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.hotrod.image.repository -}}
{{- $tag := default .Values.hotrod.image.tag .Values.global.image.tag | toString -}}
{{- if $registryName }}
    {{- printf "%s/%s:%s" $registryName $repositoryName $tag -}}
{{- else -}}
    {{- printf "%s:%s"  $repositoryName $tag -}}
...
*/}}
{{/*
Return the proper jaeger-cassandra-schema image name
*/}}
{{- define "jaeger.schema.image" -}}
{{- $registryName := default .Values.schema.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.schema.image.repository -}}
{{- $tag := default .Values.schema.image.tag .Values.global.image.tag | toString -}}
{{- if $registryName }}
    {{- printf "%s/%s:%s" $registryName $repositoryName $tag -}}
{{- else -}}
    {{- printf "%s:%s"  $repositoryName $tag -}}
...
*/}}
{{/*
Return the proper jaeger-spark-dependencies image name
*/}}
{{- define "jaeger.spark.image" -}}
{{- $registryName := default .Values.spark.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.spark.image.repository -}}
{{- $tag := default .Values.spark.image.tag .Values.global.image.tag | toString -}}
{{- if $registryName }}
    {{- printf "%s/%s:%s" $registryName $repositoryName $tag -}}
{{- else -}}
    {{- printf "%s:%s"  $repositoryName $tag -}}
...
{{/*
===============================================================================================
================= jaeger-jaeger-es-index-cleaner
===============================================================================================
*/}}
{{/*
Return the proper jaeger-jaeger-es-index-cleaner image name
*/}}
{{- define "jaeger.esIndexCleaner.image" -}}
{{- $registryName := default .Values.esIndexCleaner.image.registry .Values.global.image.registry  -}}
{{- $repositoryName := .Values.esIndexCleaner.image.repository -}}
{{- $tag := default .Values.esIndexCleaner.image.tag .Values.global.image.tag | toString -}}
{{- if $registryName }}
    {{- printf "%s/%s:%s" $registryName $repositoryName $tag -}}
{{- else -}}
    {{- printf "%s:%s"  $repositoryName $tag -}}
