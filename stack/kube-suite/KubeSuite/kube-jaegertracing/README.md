...
| `agent.image.repository` | Image Repository for Jaeger Agent | `jaegertracing/jaeger-agent` |
| `agent.image.pullSecrets` | Secret to pull the Image for Jaeger Agent | `[]` |
| `agent.image.pullPolicy` | Agent image pullPolicy | `IfNotPresent` |
...
| `collector.image.repository` | Image for jaeger collector | `jaegertracing/jaeger-collector` |
| `collector.image.tag` | Image tag for jaeger collector | `global.image.tag` |
| `collector.image.pullSecrets` | Secret to pull the Image for Jaeger Collector | `[]` |
| `collector.image.pullPolicy` | Collector image pullPolicy | `IfNotPresent` |
...
| `ingester.image.repository` | Image for jaeger Ingester | `jaegertracing/jaeger-ingester` |
| `ingester.image.tag` | Image tag for jaeger ingester | `global.image.tag` |
| `ingester.image.pullSecrets` | Secret to pull the Image for Jaeger Ingester | `[]` |
...
| `query.image.repository` | Image for Jaeger Query UI | `jaegertracing/jaeger-query` |
| `query.image.tag` | Image tag for jaeger query | `nil` |
| `query.image.pullSecrets` | Secret to pull the Image for Jaeger Query UI | `[]` |
| `query.image.pullPolicy` | Query UI image pullPolicy | `IfNotPresent` |
...
| `schema.image.repository` | Image to setup cassandra schema | `jaegertracing/jaeger-cassandra-schema` |
| `schema.image.tag` | Image tag for cassandra schema | `nil` |
| `schema.image.pullSecrets` | Secret to pull the Image for the Cassandra schema setup job | `[]` |
| `schema.image.pullPolicy` | Schema image pullPolicy | `IfNotPresent` |
...
| `spark.image.repository` | Image for the dependencies job| `jaegertracing/spark-dependencies` |
| `spark.image.tag` | Image tag for the dependencies job | `nil` |
| `spark.image.pullSecrets` | Secret to pull the Image for the Spark dependencies job | `[]` |
| `spark.image.pullPolicy` | Image pull policy of the deps image| `Always` |
...
| `esIndexCleaner.image.repository` | Image for the ElasticSearch indices cleanup job| `jaegertracing/jaeger-es-index-cleaner` |
| `esIndexCleaner.image.tag` | Image tag for the ElasticSearch indices cleanup job | `nil` |
| `esIndexCleaner.image.pullSecrets` | Secret to pull the Image for the ElasticSearch indices cleanup job | `[]` |
| `esIndexCleaner.image.pullPolicy` | Image pull policy of the ES cleanup image | `Always` |
